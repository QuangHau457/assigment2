...
import { Delete, getAll } from "../api/product"
...
const Dashboard = () => {
    ...
    return <>
        ...
        <main className='flex'>
            ...
            <section className='flex-initial w-full px-[10px] bg-slate-100  '>
                                ...
                                {products.map(product => (
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center ">
                                            <button onClick={() => checkDelete(product.id)} className="bg-red-600 text-white rounded-md p-2 "><i className="fa-sharp fa-solid fa-trash"></i></button>
