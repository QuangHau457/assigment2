...
const ProductDetail = (props:any) => {
    ...
    <div className="h-[45px] ">
        <ul className="text-slate-400 flex pl-[230px] gap-10 pt-[8px]">
        ...
        <div className="w-[800px]">
            ...
            <div className="h-[50px] flex gap-[25px] mt-[285px]">
                ...
                <div className="w-[50px] border rounded-md border-red-600 ">
                    <a href=""> <img className="px-[12px] py-[12px]" src="./card.png" alt="" /></a>
                </div>
...
<div className="w-[300px] h-[35px] text-center pY-auto my-[80px] mx-auto  rounded-lg border-black">
        <a href="#">Xem thêm</a>
    </div>
</div>
